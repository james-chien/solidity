...
//         {
//             let _7 := add(calldataload(0x04), mul(i, 0xc0))
//             let k := 0
//             let a := calldataload(add(_7, 0x44))
//             let c := challenge
//             switch eq(add(i, 0x01), n)
//             case 1 {
//                 k := kn
...
//             }
//             case 0 {
//                 k := calldataload(add(_7, 0x24))
//             }
//             validateCommitment(add(_7, 0x24), k, a)
//             switch gt(add(i, 0x01), calldataload(0x24))
//             case 1 {
...
//             calldatacopy(0xe0, add(_7, 164), 0x40)
//             calldatacopy(0x20, add(_7, 100), 0x40)
//             mstore(0x120, sub(_1, c))
//             mstore(0x60, k)
//             mstore(0xc0, a)
//             let result := call(_2, 7, 0, 0xe0, 0x60, 0x1a0, 0x40)
//             let result_1 := and(result, call(_3, 7, 0, 0x20, 0x60, 0x120, 0x40))
//             let result_2 := and(result_1, call(_4, 7, 0, 0x80, 0x60, 0x160, 0x40))
//             let result_3 := and(result_2, call(_5, 6, 0, 0x120, 0x80, 0x160, 0x40))
//             result := and(result_3, call(_6, 6, 0, 0x160, 0x80, b, 0x40))
...
//             b := add(b, 0x40)
//         }
//         if lt(calldataload(0x24), n) { validatePairing(100) }
